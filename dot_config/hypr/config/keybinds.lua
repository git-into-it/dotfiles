...
end, { desc = "Open Discord" })
hl.bind("ALT + S", function()
	hl.exec_cmd("slack", { workspace = "4" })
end, { desc = "Open Slack" })
hl.bind("ALT + V", function()
	hl.exec_cmd("virt-manager", { workspace = "5" })
end, { desc = "Open Virt Manager" })
...
hl.define_submap("resize", function()
	hl.bind(
		...
		{ repeating = true, desc = "Grow window right" }
	)
	hl.bind(
		"left",
		hl.dsp.window.resize({ x = -15, y = 0, relative = true }),
		{ repeating = true, desc = "Shrink window left" }
	)
	hl.bind(
		"up",
		hl.dsp.window.resize({ x = 0, y = -15, relative = true }),
		{ repeating = true, desc = "Shrink window up" }
	)
	hl.bind(
		"down",
		hl.dsp.window.resize({ x = 0, y = 15, relative = true }),
		{ repeating = true, desc = "Grow window down" }
	)
	hl.bind(
		"l",
		hl.dsp.window.resize({ x = 15, y = 0, relative = true }),
